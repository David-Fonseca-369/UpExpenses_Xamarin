...
namespace UpExpenses_Xamarin.Droid.GoogleServices
{
    public class AndroidNotificationManager
    {
        ...
        void CreateNotificationChannel()
        {
            ...
            //Comprobamos la versión de Android, versiones superoiores a Android Oreo, fallará si 
            //no se crea un canal.
        ...
        {
            //Si ya está creado el canal, si no que lo cree.
            ...
            //intent.PutExtra(ImageUrlKey, pIcon);//
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(AndroidApp.Context, channelId)
                ...
                .SetAutoCancel(true)
                //.SetLargeIcon(BitmapFactory.DecodeResource(AndroidApp.Context.Resources, Resource.Drawable.abc_list_divider_material))
