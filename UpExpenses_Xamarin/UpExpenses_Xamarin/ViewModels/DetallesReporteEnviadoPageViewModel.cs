...
{
    public class DetallesReporteEnviadoPageViewModel : BaseViewModel
    {
        ...
        public DetallesReporteEnviadoPageViewModel(INavigation navigation)
        {
        ...
        private async Task<bool> LoadHeadboardReport()
        {
            ...
            if (listHeaderboard != null)
            {
                ...
                //Si agrega un número del proyecto
