...
{
    public class GastosPendientesPageViewModel : BaseViewModel
    {
        private IList<CardGasto> gastosPendientes;
        public IList<CardGasto> GastosPendientes
        {
            get => gastosPendientes;
            set => SetProperty(ref gastosPendientes, value);
        }
        ...
        public GastosPendientesPageViewModel(INavigation navigation)
        {
